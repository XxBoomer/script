...
TextLabel.Text = "Blox Fruit Script"
...
TextButton.Text = "Unfazed Script"
...
TextButton.MouseButton1Click:connect(unfazed)
...
TextButton_2.Text = "MagmaHub Script"
...
TextButton_2.MouseButton1Click:connect(magma)
